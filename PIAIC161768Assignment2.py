...
def function5():
    ...
    z = np.zeros(shape=(4,5)).astype(int)#wrtie your code here
...
def function13():
    ...
    ans = arr[(arr>=5) & (arr<=9)]#write your code here
...
def function18():
    ...
    x = [x for x in students if x not in piaic]
    x = len(x) # Write you code Here
    return x
